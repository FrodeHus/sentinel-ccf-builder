      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            />
            {dataFlow.streamName && !dataFlow.streamName.startsWith("Custom-") && (
              <p className="text-xs text-destructive">Stream name must start with &quot;Custom-&quot;</p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <KqlEditor
              ...
              onChange={transformKql => updateDataFlow({ transformKql })}
            />
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <input
                ...
                onChange={e => updateDataFlow({ inputColumnsOverride: e.target.checked })}
            ...
            <p className="text-xs text-muted-foreground">
              Enable this if your application sends data with different field names than the table columns.
              The KQL transform handles the mapping.
            </p>
            ...
            {dataFlow.inputColumnsOverride && (
              <div className="pl-4 border-l-2 border-muted">
                ...
                <SchemaEditor
                  ...
                  onChange={inputColumns => updateDataFlow({ inputColumns })}
                />
              </div>
            )}
          </div>
        ...
        <CollapsibleContent>
          <Card className="mt-2">
            <CardContent className="pt-4 text-sm text-muted-foreground space-y-2">
              <p>The DCR acts as a pipeline: data comes in from your app, gets transformed, and lands in the table.</p>
              <p>If your app already sends a <code>TimeGenerated</code> field, use <code>source</code> as the transform. Otherwise, the default adds it automatically.</p>
              <p>The <strong>stream name</strong> is used by your application when sending data to the ingestion endpoint.</p>
            </CardContent>
          </Card>
        </CollapsibleContent>
      </Collapsible>
