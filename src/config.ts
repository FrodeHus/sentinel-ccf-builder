...
export const CONFIG = {
  ...
  DOMPURIFY_CONFIG: {
    ALLOWED_TAGS: ['svg', 'path', 'circle', 'rect', 'line', 'polyline', 'polygon', 'g', 'defs', 'clipPath', 'mask', 'pattern', 'linearGradient', 'radialGradient', 'stop', 'use', 'title', 'desc'],
    ALLOWED_ATTR: ['viewBox', 'xmlns', 'd', 'fill', 'stroke', 'stroke-width', 'stroke-linecap', 'stroke-linejoin', 'cx', 'cy', 'r', 'x', 'y', 'width', 'height', 'transform', 'id', 'class', 'x1', 'y1', 'x2', 'y2', 'points', 'offset', 'stop-color', 'stop-opacity', 'fill-opacity', 'stroke-opacity', 'href', 'xlink:href'],
    KEEP_CONTENT: false,
    RETURN_DOM: false,
